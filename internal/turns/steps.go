...
func Step(turnId string, move *parser.Move_t, location, leader coords.Map, worldMap *tiles.Map_t, scouting, debug bool) (coords.Map, error) {
	...
	err = to.MergeReports(turnId, move.Report, worldMap, scouting)
